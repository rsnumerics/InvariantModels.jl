...
@inline ManifoldsBase.get_forwarding_type(::Dense_Polynomial, ::Any, P::Type) = ManifoldsBase.SimpleForwardingType()

function Dense_Polynomial(
        Output_Dimension, Input_Dimension, Skew_Dimension, Start_Order, End_Order;
...
function Base.zero(
        M::Dense_Polynomial{
            Output_Dimension, Input_Dimension, Skew_Dimension, Start_Order,
            End_Order, field,
        }
