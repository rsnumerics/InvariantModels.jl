...
if Generate
    dd = matread("decaying_data.mat")
    Time_Step = dd["dev4955"]["scopes"]["wave"][1]["dt"]
    input_signal = dd["dev4955"]["scopes"]["wave"][1]["wave"]
    Raw_Signal = reshape(input_signal[28_200:round(Int, 0.7 * length(input_signal))], 1, :)
