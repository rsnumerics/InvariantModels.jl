...
```math
\dot{r}_{1} = -\frac{1}{500}r_{1}+\frac{1}{100}r_{1}^{3}-\frac{1}{10}r_{1}^{5},  \qquad \dot{\theta}_{1} = 1+\frac{1}{4}r_{1}^{2}-\frac{3}{10}r_{1}^{4},\\
```
```math
\dot{r}_{2} = -\frac{\mathrm{e}}{500}r_{2} - \frac{1}{10}r_{2}^{5},             \qquad  \dot{\theta}_{2} = \mathrm{e}+\frac{3}{20}r_{2}^{2}-\frac{1}{5}r_{2}^{4},\\
```
```math
\dot{r}_{3} = -\frac{1}{50}\sqrt{\frac{3}{10}}r_{3}+\frac{1}{100}r_{3}^{3}-\frac{1}{10}r_{3}^{5},\qquad  \dot{\theta}_{3} =\sqrt{30}+\frac{9}{50}r_{3}^{2}-\frac{19}{100}r_{3}^{4},\\
```
```math
\dot{r}_{4} = -\frac{1}{500}\pi^{2}r_{4}+\frac{1}{100}r_{4}^{3}-\frac{1}{10}r_{4}^{5}, \qquad  \dot{\theta}_{4} = \pi^{2}+\frac{4}{25}r_{4}^{2}-\frac{17}{100}r_{4}^{4},\\
```
```math
\dot{r}_{5} = -\frac{13}{500}r_{5}+\frac{1}{100}r_{5}^{3}, \qquad \dot{\theta}_{5} = 13+\frac{4}{25}r_{5}^{2}-\frac{9}{50}r_{5}^{4}.
```
...
```math
\boldsymbol{f}\left(\boldsymbol{z}\right)=\left[D\boldsymbol{g}^{-1}\left(\boldsymbol{h}\left(\boldsymbol{z}\right)\right)D\boldsymbol{h}\left(\boldsymbol{z}\right)\right]^{-1}\boldsymbol{f}_{0}\left(\boldsymbol{g}^{-1}\left(\boldsymbol{h}\left(\boldsymbol{z}\right)\right)\right).
```
